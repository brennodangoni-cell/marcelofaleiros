<?php
/**
 * Script para enviar emails do formulário de contato
 * Configurado para usar SMTP do HostGator
 */
...
$email_remetente = 'contato@marcelofaleirosterapeuta.com'; // Email que enviará
...
// Função para enviar email via SMTP usando sockets
function enviarEmailSMTP($para, $assunto, $corpo, $de_email, $de_nome, $reply_to, $smtp_host, $smtp_port, $smtp_user, $smtp_pass) {
    try {
        // Tentar usar PHPMailer se disponível (mais confiável)
        if (class_exists('PHPMailer\PHPMailer\PHPMailer')) {
            ...
            $mail->addReplyTo($reply_to, $de_nome);
...
// Preparar reply-to
$reply_to_email = htmlspecialchars($email);
$reply_to_nome = htmlspecialchars($nome);
